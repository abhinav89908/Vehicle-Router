...
const SVRP = () => {
    ...
    const process = async (event) =>{
        ...
        let numVehicles = document.getElementById('numVehicles').value;
        str = str + x + "%20" + y + "&num_vehicles=" + numVehicles + "&depot=" + coordinates.length;
        try{
                            ...
                            <form action="" onSubmit={formSubmit} >
                                ...
                                <div className="mb-3" >
                                    <label htmlFor={`formGroupExampleInputDepot`} className="form-label" >
                                        Enter number of Vehicles in depot:
                                    </label>
                                    <input 
                                        id='numVehicles'
